 ...
 * @Last Modified time: 2018-09-10 10:55:42
 */
?>
  ...
  <link rel="text/css" href="assets/css/custom.css">
        ...
        <div class="side-navbar-wrapper">
         ...
         <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center">
            ...
            <h2 class="h5">{{baseuser.name}}</h2><span>Admin</span>
          </div>
    ...
    <div class="main-menu">
      ...
      <ul id="side-main-menu" class="side-menu list-unstyled">                  
        <li ng-class="{'active' : currentLin == 'admin-dashboard' }" ><a href="admin-dashboard"> <i class="icon-home"></i>Home                             </a></li>
        <li  ng-class="{'active' : currentLin == 'admin-profile' }"><a href="admin-profile"> <i class="icon-user"></i>Profile                             </a></li> 
        <li  ng-class="{'active' : currentLin == 'admin-settings' }"><a href="admin-settings"> <i class="fas fa-cog"></i>Settings                             </a></li> 
        <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fas fa-users"></i>  Users
          <div class="badge badge-success" ng-if="newUserCount" title="{{newUserCount}} new users">{{newUserCount}} new users </div></a></li>
        </a>
        <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
          <li><a href="admin-confirmation">Confirm <div class="badge badge-warning" ng-if="newUserCount">{{newUserCount}}  </div></a></li>
          <li><a href="admin-user-existing">Existing</a></li> 
        </ul>  
      </ul>
    </div>
    <div class="admin-menu">
     <h5 class="sidenav-heading">Reports</h5>
     <ul id="side-admin-menu" class="side-menu list-unstyled"> 
      <li> <a href="admin-reported-disease"> <i class="far fa-file-alt"> </i>View Data</a></li>
      <li> <a href="admin-export-report"> <i class="fas fa-file-excel"> </i>Export Data</a></li>
      <li> <a href="admin-reported-file"> <i class="fas fa-paperclip"> </i>View Files </a></li> 
    </ul>
  </div>
</div>
</nav>

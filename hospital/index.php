 ...
 * @Last Modified time: 2018-09-10 12:11:36
 */
?>
...
?>
<!DOCTYPE html>
<html  lang="en"  ng-app="app-hospital">
<head>
	<meta charset="utf-8">
  ...
  <link rel="stylesheet" href="assets/css/custom.css">
    ...
    <!-- Tweaks for older IEs--><!--[if lt IE 9]>
      ...
      <script type="text/javascript"   src="hospital/js/app.js"></script>
    ...
    <div class="main-menu">
      ...
      <ul id="side-main-menu" class="side-menu list-unstyled">                  
        <li ng-class="{'active' : currentLin == 'hospital-dashboard' }" ><a href="hospital-dashboard"> <i class="icon-home"></i>Home                             </a></li>
        <li  ng-class="{'active' : currentLin == 'hospital-profile' }"><a href="hospital-profile"> <i class="icon-user"></i>Profile                             </a></li> 
        <li  ng-class="{'active' : currentLin == 'hospital-settings' }"><a href="hospital-settings"> <i class="fas fa-cog"></i>Settings                             </a></li> 
        <li>
          <a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"ng-click="openurlnew1()"> <i class="fas fa-plus"></i>  Report
          </a> 

          <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
            <li><a href="hospital-report-disease">New  </a></li>
            <li><a href="hospital-reported-disease">Reported</a></li> 
          </ul>
        </li>

        <li>
          <a href="#fileDrop" aria-expanded="false" data-toggle="collapse" ng-click="openurlnew2()"> <i class="far fa-file-alt"></i>  Report Files
          </a> 

          <ul id="fileDrop" class="collapse list-unstyled ">
            <li><a href="hospital-report-file">New  </a></li>
            <li><a href="hospital-reported-file">Reported</a></li> 
          </ul>
        </li>
